...
export const contactAdaptor = createEntityAdapter(); // crud işlemleri için
...
export const {addContact, addContacts,deleteContact,removeAllContact,updateContact} = contactSlice.actions;
